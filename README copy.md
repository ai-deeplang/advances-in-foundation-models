...
1. **Weeks 1 - 4**: In the first half, we'll cover the fundamentals and "need-to-know" of foundation models, and provide a general survey of the field. A complete list of topics and related readings can be found [here](https://ai-deeplang.github.io/advances-in-foundation-models/syllabus/). The primary format will be lectures taught by course instructors.
...
An updating schedule of individual classes and topics can be found on the [Calendar](https://ai-deeplang.github.io/advances-in-foundation-models/calendar/) page (currently up to Week 5).
...
### 1. Early assignment
Both the [early assignment](https://ai-deeplang.github.io/advances-in-foundation-models/assignment/) and the [quarter-long project](https://ai-deeplang.github.io/advances-in-foundation-models/project/) are designed to get you hands-on experience with foundation models. 
...
More information will shortly be available [here](https://ai-deeplang.github.io/advances-in-foundation-models/assignment/). 
...
More information will shortly be available [here](https://ai-deeplang.github.io/advances-in-foundation-models/projected/). We will also update the page with a list of potential project ideas and resources.

### 3. Class attendance and participation 
Starting in Week 3 (1/25/2023), classes will feature guest speakers and the opportunity to ask questions in **follow-up Q&As**. We encourage you to be active during these sessions. To help prepare, as the quarter progress, additional information about upcoming speakers and relevant readings will be added to the [Calendar](https://ai-deeplang.github.io/advances-in-foundation-models/calendar/) page. These will be updated at least three days in advance of each class; we encourage you to read the relevant materials ahead of time.
